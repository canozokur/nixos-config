        ...
        children
          pane size=1 borderless=true {
            plugin location="file:${pkgs.zjstatus}/bin/zjstatus.wasm" {
              ...
              mode_locked        "#[bg=$red,fg=$base] L #[fg=$red,bg=$base]"
              mode_resize        "#[bg=$teal,fg=$base] r #[fg=$teal,bg=$base]"
              mode_pane          "#[bg=$mauve,fg=$base] p #[fg=$mauve,bg=$base]"
              mode_scroll        "#[bg=$blue,fg=$base] s #[fg=$blue,bg=$base]"
              mode_enter_search  "#[bg=$lavender,fg=$base,bold] / #[fg=$lavender,bg=$base]"
              mode_search        "#[bg=$sapphire,fg=$base] S #[fg=$sapphire,bg=$base]"
              mode_rename_tab    "#[bg=$green,fg=$base] E #[fg=$green,bg=$base]"
              mode_rename_pane   "#[bg=$green,fg=$base] e #[fg=$green,bg=$base]"
              mode_session       "#[bg=$rosewater,fg=$base] S #[fg=$rosewater,bg=$base]"
              mode_move          "#[bg=$maroon,fg=$base] M #[fg=$maroon,bg=$base]"
              mode_prompt        "#[bg=$green,fg=$base] ? #[fg=$green,bg=$base]"

              tab_normal            "#[fg=$base,bg=$overlay0]  {index}  #[fg=$overlay0,bg=$base]"
              tab_normal_fullscreen "#[fg=$base,bg=$overlay0]  {index}{fullscreen_indicator} #[fg=$overlay0,bg=$base]"
              tab_normal_sync       "#[fg=$base,bg=$overlay0]  {index}{sync_indicator} #[fg=$overlay0,bg=$base]"
              tab_active            "#[fg=$base,bg=$blue,bold]  {index}  #[fg=$blue,bg=$base]"
              tab_active_fullscreen "#[fg=$base,bg=$blue,bold]  {index}{fullscreen_indicator} #[fg=$blue,bg=$base]"
              tab_active_sync       "#[fg=$base,bg=$blue,bold]  {index}{sync_indicator} #[fg=$blue,bg=$base]"
